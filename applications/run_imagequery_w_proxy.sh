...
docker run -e MODEL_NAME=test -p 7000:7000 imagequery_w_proxy:c0 & 
...
docker run -e MODEL_NAME=test -p 11000:11000 imagequery_w_proxy:c3  &
docker run -e MODEL_NAME=test -p 12000:12000 imagequery_w_proxy:c4  &
