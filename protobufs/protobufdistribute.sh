...
cp management_pb2_grpc.py ../clipper_admin/clipper_admin/rpc/
cp management_pb2.py ../clipper_admin/clipper_admin/rpc/
...
cp management_pb2_grpc.py ../grpcclient/app/
cp management_pb2.py ../grpcclient/app/

rm *.py

cd ../clipper_admin/clipper_admin/rpc/ && sed -i -e 's/^import.*_pb2/from . \0/' *.py
