...
class ManagementServerServicer(management_pb2_grpc.ManagementServerServicer):
    ...
    def __init__(self, redis_name, redis_port):
        ...
        self.admin = ClipperConnection(DockerContainerManager())
    ...
    def ReportContainerFailure(self, request, context):
        ...
        proxy_name, proxy_id = self.admin.cm.set_proxy("mxschen/ai-proxy:latest",container_name, container_ip, scheduled_host, recovery=True)
