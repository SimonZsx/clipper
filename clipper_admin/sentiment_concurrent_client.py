...
def bigball(ip, port, inputt):
    # Better to use clipper to process bigball container.
    return "bigball"
...
def main():
    ...
    parser.add_argument('--system', nargs=1, type=str, help="System name: oursystem/withoutproxy/clipper")
                       
    args = parser.parse_args()
     
    # Generate your inputt list here
    inputt_total = [str(i) for i in range(700,796)]
    import random
