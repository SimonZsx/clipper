...
class DockerContainerManager(ContainerManager):
    def __init__(self,
        ...
        self.proxy_image = "mxschen/ai-proxy"
        if redis_ip is None:
    ...
    def start_clipper(self,
        ...
        #self.clipper_management_port = 55555
        #find_unbound_port(
        ...
        admin_container = self.docker_client.containers.run(
            ...
            ports={
                '%s/tcp' % CLIPPER_INTERNAL_MANAGEMENT_PORT:self.clipper_management_port
            },
    ...
    def add_frontend(self, host_ip, image, runtime_dag_id, entry_proxy_ip, entry_proxy_port, max_workers=64, stateful=False, remove=True):
        ...
        labels = self.common_labels.copy()
        labels[CLIPPER_MODEL_CONTAINER_LABEL] = frontend_name
        labels[CLIPPER_DOCKER_LABEL] = self.cluster_name
